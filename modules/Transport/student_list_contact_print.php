...
if($_GET) {
	if($_REQUEST['action']=='print')
	{
		$sql="SELECT gibbonperson.gibbonPersonID,gibbonperson.officialName as officialname,gibbonyeargroup.name AS class,
			gibbonrollgroup.name AS section,gibbonperson.account_number,gibbonstudentenrolment.rollOrder,gibbonapplicationform.parent1officialName,
			gibbonapplicationform.parent2officialName,gibbonapplicationform.parent1phone1,gibbonapplicationform.parent1phone1,gibbonapplicationform.parent2phone1,
			`transport_spot_price`.`spot_name`,`transport_pickup_drop`.`pd_point` 
			 FROM gibbonperson 
			LEFT JOIN gibbonapplicationform ON gibbonapplicationform.gibbonApplicationFormID=gibbonperson.gibbonApplicationFormID
			...
			LEFT JOIN `transport_spot_price` ON `transport_spot_price`.`transport_spot_price_id`=`gibbonperson`.`transport_spot_price_id` 
...
?>
	...
	<tr style="background:#dddddd;">
		...
		<td align="center" style="border-bottom:1px solid #000000; border-right:1px solid  #000000;font-family:Arial, Helvetica, sans-serif; font-weight: bold;font-size: 14px; color:#000000;" >Parents</td>
		<td align="center" style="border-bottom:1px solid #000000; border-right:1px solid  #000000;font-family:Arial, Helvetica, sans-serif; font-weight: bold;font-size: 14px; color:#000000;">Contact No</td>
...
$i=1;
		while ($row=$result->fetch()) {
						print "<tr>" ;
							print 	'<td align="right" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$i++.'</td>';
							print 	'<td align="right" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.($row["account_number"]+0).'</td>';
							print 	'<td align="left" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["officialname"].'</td>';
							print 	'<td align="right" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["rollOrder"].'</td>';
							print 	'<td align="left" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["class"]." ".$row["section"].'</td>';			
							print 	'<td align="left" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["parent1officialName"]." , ".$row["parent2officialName"].'</td>';			
							print 	'<td align="right" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["parent1phone1"]."<br>".$row["parent2phone1"].'</td>';			
							print 	'<td align="left" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["spot_name"].'</td>';			
							print 	'<td align="left" style="border-bottom:1px solid #000000; 	border-right:1px solid #000000; font-size:14px; color:#000000;">'.$row["pd_point"].'</td>';			
						print "</tr>" ;
		}
		print "</table>";
