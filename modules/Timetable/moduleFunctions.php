				...
				$output.="<td>" ; 
					...
					while ($row=$result->fetch()) {
						$output.="<form method='post' action='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=$q" . $params . "&gibbonTTID=" . $row["gibbonTTID"] . "'>" ;
							...
							$output.="<input class='' style='min-width: 30px; margin-top: 0px; float: left' type='submit' value='" . $row["name"] . "'>" ;
						$output.="</form>" ;
					}
					try {
						$result=$connection2->prepare($sql);
			...
			$output.="<tr>" ;
				$output.="<td style='vertical-align: top'>" ; 
					$output.="<form method='post' action='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=$q" . $params . "&gibbonTTID=" . $row["gibbonTTID"] . "'>" ;
						...
						$output.="<input class='' style='min-width: 30px; margin-top: 0px; float: left' type='submit' value='" . _('Last Week') . "'>" ;
					$output.="</form>" ;
					$output.="<form method='post' action='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=$q" . $params . "&gibbonTTID=" . $row["gibbonTTID"] . "'>" ;
						$output.="<input name='ttDate' value='" . date($_SESSION[$guid]["i18n"]["dateFormatPHP"], ($startDayStamp+(7*24*60*60))) . "' type='hidden'>" ;
						$output.="<input name='schoolCalendar' value='" . $_SESSION[$guid]["viewCalendarSchool"] . "' type='hidden'>" ;
						...
						$output.="<input class='' style='min-width: 30px; margin-top: 0px; float: left' type='submit' value='" . _('Next Week') . "'>" ;
					$output.="</form>" ;
				$output.="</td>" ; 
				$output.="<td style='vertical-align: top; text-align: right'>" ;
					$output.="<form method='post' action='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=$q" . $params . "&gibbonTTID=" . $row["gibbonTTID"] . "'>" ; 
						...
						$output.="<script type=\"text/javascript\">" ;
						 ...
						 $output.="<script type=\"text/javascript\">" ;
							$output.="$(function() {" ;
								$output.="$(\"#ttDate\").datepicker({ dateFormat: 'dd/mm/yy'} );" ;
							$output.="});" ;
						$output.="</script>" ;
