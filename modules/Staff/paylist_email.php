...
<h3>Payslip List: </h3>
	...
	<input type="hidden" name="q" value="/modules/<?php print $_SESSION[$guid]["module"] ?>/paylist_email.php">
	<table width="80%" cellpadding="0" cellspacing="0" align='center'>
		<tr>
			...
			<td><select name='year' id='year' required><option value=''> Select Year </option>
