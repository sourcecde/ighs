...
///else {
	...
	//else {
		...
		print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . _(getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" . _('Manage Contract Employee') . "</div>" ;
		print "</div>" ;
		...
		print "<h2>" ;
		print _("Manage Contract Employee: ") ;
		print "</h2>" ;
...
//}
?>
<input type="hidden" id="linkURL" value="<?php echo $_SESSION[$guid]["absoluteURL"] ;?>/modules/Staff/ajax_staff_contract.php">
