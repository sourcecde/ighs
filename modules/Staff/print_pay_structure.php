...
if(isset($_REQUEST['sid'])){
 ...
 <h3>View Pay Structure For Month: <?php echo $month_name[($m_y[0]-1)];?> of Year: <?php echo $year['name'];?></h3>
	  ...
	  <tr style="border: 1px solid black; border-collapse: collapse;">
		...
		?>
			<tr >
				...
				<td style="border: 1px solid black; border-collapse: collapse; text-align:right;">
					<?php 
					$esi=$structure_d[$sn['gibbonStaffID']+0][98]<21000?ceil($structure_d[$sn['gibbonStaffID']+0][98]*$structure_d[0][96]/100):0;
					echo $esi;
					$n_amount-=$esi;
						?>
				</td >
