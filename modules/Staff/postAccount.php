...
<tr>
	<td><b>From Date :</b>
	<input type="text" name="from_date" id="from_date" value="<?php echo $from_date;?>" required style="text-align:center; width:100px;" disabled></td>
	<td><b>To Date :</b>
	<input type="text" name="to_date" id="to_date" value="<?php echo $to_date;?>" required style="text-align:center; width:100px;" placeholder=" To Date"></td>
	</td>
	<td>
