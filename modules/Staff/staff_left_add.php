...
// if (isActionAccessible($guid, $connection2, "/modules/Staff/staff_left_add.php")==FALSE) {
// 	//Acess denied
...
?>	
	...
	<form  method='POST' action='<?php print $_SESSION[$guid]["absoluteURL"]?>/modules/<?php print $_SESSION[$guid]["module"] ?>/process_staff_left_edit.php' enctype='multipart/form-data'>
	...
	<tr><td><b>Name: </b><select name='p_name'  style='width:250px;'>
						<option value=''>Select Name</option>
				<?php
				//print_r($data);gibbonStaffID
