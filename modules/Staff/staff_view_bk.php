...
?>
<input type="hidden" id="linkURL" value="<?php echo $_SESSION[$guid]["absoluteURL"] ;?>/modules/Staff/ajax_staff_view.php">
...
$(document).ready(function(){
 ...
 var   retuen_value=confirm("Are you sure!");
    if(retuen_value=='true'){
            <?php
        $sql="DELETE FROM `gibbonstaff` WHERE gibbonStaffID=".$_GET['gibbonStaffID'];
	    $result=$connection2->prepare($sql);
	    $result->execute();
