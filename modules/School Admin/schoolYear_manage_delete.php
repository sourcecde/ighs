...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/schoolYear_manage_delete.php")==FALSE) {
	...
	if ($gibbonSchoolYearID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/schoolYear_manage_deleteProcess.php?gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
