...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/yearGroup_manage_edit.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . _(getModuleName($_GET["q"])) . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/yearGroup_manage.php'>Manage Year Groups</a> > </div><div class='trailEnd'>Edit Year Group</div>" ;
	print "</div>" ;
