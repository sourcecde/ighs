...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/schoolYearTerm_manage_delete.php")==FALSE) {
	...
	if ($gibbonSchoolYearTermID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/schoolYearTerm_manage_deleteProcess.php?gibbonSchoolYearTermID=$gibbonSchoolYearTermID" ?>">
