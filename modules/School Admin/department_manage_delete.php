...
if (isActionAccessible($guid, $connection2, "/modules/School Admin/department_manage_delete.php")==FALSE) {
	...
	if ($gibbonDepartmentID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/department_manage_deleteProcess.php?gibbonDepartmentID=$gibbonDepartmentID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					...
					<tr>
						<td> 
							<input name="gibbonDepartmentID" id="gibbonDepartmentID" value="<?php print $gibbonDepartmentID ?>" type="hidden">
