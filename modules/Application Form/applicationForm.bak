...
if ($proceed==FALSE) {
	...
	<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/applicationFormProcess.php" ?>" enctype="multipart/form-data" class="studentappform">
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				<td> 
					...
					if ($_SESSION[$guid]["country"]=="") {
						...
						print "<b>" . $_SESSION[$guid]["country"] . " " . _('ID Card Number (Adhar Card No.)') . "</b><br/>" ;
					}
					?>
				</td>
				<td class="right">
				...
				<tr>
					...
					<td class="right">
						...
						<select name="phone<?php print $i ?>CountryCode" id="phone<?php print $i ?>CountryCode" style="width: 60px">
							<?php
							//print "<option value=''></option>" ;
							print "<option value='91'>91 - India</option>" ;
							try {
								$dataSelect=array(); 
			...
			<tr>
				<td> 
					<b><?php print _('Class at Entry') ?> *</b><br/>
			...
			<tr>
				<td> 
					<b><?php print _('Boarder Type') ?> *</b><br/>
					<!--<span style="font-size: 90%"><i><?php print _('Which year level will student enter.') ?></i></span>-->
				</td>
				<td class="right">
					<select name="boarder_type" id="boarder_type" style="width: 302px">
						<option value='Please select...'>Please select...</option>			
						<option value='N'>Non Boarder</option>			
						<option value='D'>Day Boarder</option>			
						<option value='Y'>Boarder</option>			
					</select>
					<script type="text/javascript">
						var boarder_type=new LiveValidation('boarder_type');
						boarder_type.add(Validate.Exclusion, { within: ['Please select...'], failureMessage: "<?php print _('Select something!') ?>"});
					 </script>
				</td>
			</tr>
			<!-- Boarder Type-->
			...
			<tr>
				<td colspan=2> 
					<?php
					print "<table cellspacing='0' style='width: 100%' class='schooldata'>" ;
						print "<tr class='head'>" ;
							print "<th>" ;
								print _("School Name") ;
							print "</th>" ;
			...
			/*	if (isset($_SESSION[$guid]["username"])) {
				...
				for ($i=$start;$i<3;$i++) {
					...
					<tr class='break'>
						<td colspan=2> 
							<h3><!--changes-->
								...
								<?php
								if ($i==1) {
									print _('MOTHER DETAILS');
								}
								else if ($i==2 AND $gibbonPersonID=="") {
									print _('FATHER DETAILS') ;
								}
								?>
							</h3>
						</td>
							...
							<td class='right' colspan=2> 
								<script type="text/javascript">
									...
									$(document).ready(function(){
										$("#parent2title").find('option').remove().end().append("<option value='Ps '>Please Select...</option>");
										$("#parent2title").append("<option value='Mr. '>Mr.</option>");
										$("#parent2title").append("<option value='Dr. '>Dr.</option>");
										$("#parent2gender").find('option').remove().end().append("<option value='M'>Male</option>");
										$("#parent2relationship").find('option').remove().end().append("<option value='Father'>Father</option>");
					...
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td colspan=2> 
							<h4><?php $i==2 ? print _('FATHER'):print _('MOTHER') ?> <?php print _('Personal Data') ?></h4> <!--changes-->
						</td>
					</tr>
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td> 
						...
						<td class="right">
							<select style="width: 302px" id="<?php print "parent$i" ?>title" name="<?php print "parent$i" ?>title">
								<option value="Please select..."><?php print _('Please select...') ?></option> <!--changes-->
					...
					<!--Made Changes here-->
							<select name="<?php print "parent$i" ?>gender" id="<?php print "parent$i" ?>gender" hidden=true style="width: 302px">
							<option value="F"><?php print _('Female') ?></option>
							</select>
						
							<select name="<?php print "parent$i" ?>relationship" id="<?php print "parent$i" ?>relationship" hidden=true style="width: 302px">
								<option value="Mother"><?php print _('Mother') ?></option>
							</select>
					...
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td colspan=2> 
							<h4><?php $i==2 ? print _('FATHER'):print _('MOTHER') ?> <?php print _('Personal Background') ?></h4>
						</td>
					</tr>
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td> 
					...
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td colspan=2> 
							<h4><?php $i==2 ? print _('FATHER'):print _('MOTHER') ?> <?php print _('Contact') ?></h4>
						</td>
					</tr>
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td> 
					...
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td colspan=2> 
							<h4><?php $i==2 ? print _('FATHER'):print _('MOTHER') ?> <?php print _('Employment') ?></h4>
						</td>
					</tr>
					<tr <?php if ($i==2) { print "class='secondParent'" ; }?>>
						<td> 
			...
			/*else {
				...
				<tr class='break'>
					<td colspan=2> 
						...
						<?php
						print "<table cellspacing='0' style='width: 100%' class='familydata'>" ;
							print "<tr class='head'>" ;
								print "<th>" ;
									print _("Family Name") ;
								print "</th>" ;
			...
			<tr>
				<td colspan=2> 
					<?php
					print "<table cellspacing='0' style='width: 100%' class='siblingdata'>" ;
						print "<tr class='head'>" ;
							print "<th>" ;
							...
							while ($rowSibling=$resultSibling->fetch()) {
								...
								print "<tr class=$rowNum>" ;
									...
									print "<td>" ;
										...
										<script type="text/javascript">
											$(function() {
												$( "#<?php print "siblingDOB$rowCount" ?>" ).datepicker({dateFormat : 'dd/mm/yy'});
											});
										</script>
										<?php
									print "</td>" ;
									...
									print "<td>" ;
										...
										<script type="text/javascript">
											$(function() {
												$( "#<?php print "siblingSchoolJoiningDate$rowCount" ?>" ).datepicker({dateFormat : 'dd/mm/yy'});
											});
										</script>
										<?php
									print "</td>" ;
						...
						for ($i=$rowCount; $i<4; $i++) {
							...
							print "<tr class=$rowNum>" ;
								...
								print "<td>" ;
									...
									<script type="text/javascript">
										$(function() {
											$( "#<?php print "siblingDOB$i" ?>" ).datepicker({dateFormat : 'dd/mm/yy'});
										});
									</script>
									<?php
								print "</td>" ;
								...
								print "<td>" ;
									...
									<script type="text/javascript">
										$(function() {
											$( "#<?php print "siblingSchoolJoiningDate$i" ?>" ).datepicker({dateFormat : 'dd/mm/yy'});
										});
									</script>
									<?php
								print "</td>" ;
