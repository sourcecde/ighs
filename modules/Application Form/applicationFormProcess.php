...
if ($proceed==FALSE) {
	...
	if (is_null($id)) {
		...
		if(isset($_POST["developmentInformation"]))
		{
		...
		$parent1preferredName=$parent1title." ".$parent1firstName." ".$parent1surname;
		if (isset($_POST["parent1preferredName"])) {
			$parent1preferredName=$_POST["parent1preferredName"] ;
		}
		$parent1officialName=$parent1title." ".$parent1firstName." ".$parent1surname;
		...
		$parent2preferredName=$parent2title." ".$parent2firstName." ".$parent2surname;
		if (isset($_POST["parent2preferredName"])) {
			$parent2preferredName=$_POST["parent2preferredName"] ;
		}
		$parent2officialName=$parent2title." ".$parent2firstName." ".$parent2surname;
		...
		*/
	if ($surname=="" OR $firstName=="" OR $officialName==""  OR $gender=="" OR $dob=="" OR $gibbonSchoolYearIDEntry=="" OR $dateStart=="" OR $gibbonYearGroupIDEntry==""  ) {
			//Fail 3
			$URL.="&addReturn=fail3" ;
			header("Location: {$URL}");
		}
