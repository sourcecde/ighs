...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/family_manage_edit_deleteChild.php")==FALSE) {
	...
	if ($gibbonPersonID=="" OR $gibbonFamilyID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/family_manage_edit_deleteChildProcess.php?gibbonFamilyID=$gibbonFamilyID&gibbonPersonID=$gibbonPersonID&search=$search" ?>">
