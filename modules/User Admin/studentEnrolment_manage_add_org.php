					...
					<td class="right">
						<select name="gibbonPersonID" id="gibbonPersonID" style="width: 302px" class="select_student_dropdown">
							...
							try {
								...
								WHERE gibbonperson.status='Full' AND gibbonRoleIDPrimary=003 AND gibbonPersonID NOT IN (SELECT gibbonPersonID FROM gibbonstudentenrolment WHERE 1) ORDER BY officialName ASC" ;
							...
							while ($rowSelect=$resultSelect->fetch()) {
								...
								print "<option value='" . $rowSelect["gibbonPersonID"] . "'>" . htmlPrep($rowSelect["officialName"])." - ".$rowSelect['class']."</option>" ;
							}
							?>				
						</select>
						<script type="text/javascript">
