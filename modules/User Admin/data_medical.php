...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/data_medical.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . _(getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" . _('Medical Data Updates') . "</div>" ;
	print "</div>" ;
				...
				print "<tr class=$rowNum>" ;
					...
					print "<td>" ;
						if ($row["status"]=="Pending") {
							print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/data_medical_edit.php&gibbonPersonMedicalUpdateID=" . $row["gibbonPersonMedicalUpdateID"] . "'><img title='" . _('Edit') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/config.png'/></a> " ;
							print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/data_medical_delete.php&gibbonPersonMedicalUpdateID=" . $row["gibbonPersonMedicalUpdateID"] . "'><img title='" . _('Delete') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/garbage.png'/></a>" ;
						}
					print "</td>" ;
				print "</tr>" ;
			}
