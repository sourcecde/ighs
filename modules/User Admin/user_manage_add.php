...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/user_manage_add.php")==FALSE) {
	...
	if (!($addReturn=="")) {
		if ($addReturn=="fail0") {
			...
			$addReturnMessage=_("Your request was completed successfully, but one or more images were the wrong size and so were not saved. You can now add another record if you wish.") ;	
			$class="success" ;
		}
		...
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				<td> 
					...
					<span style="font-size: 90%"><i><?php print _('When is the student expected to Passout?') ?></i></span>
				</td>
				<td class="right">
			...
			<tr>
				...
				<td class="right">
					<input name="annual_incode" id="annual_incode" maxlength=30 value="" type="text" style="width: 300px">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="right">
					<!--  <input name="boarder" id="boarder" maxlength=10 value="" type="text" style="width: 300px">-->
					<select name="boarder" id="boarder">
					<option value="Y">Border</option>
					<option value="N">Non Border</option>
					<option value="D">Day Border</option>
					</select>
				</td>
			</tr>
			...
			<tr>
				<td> 
					<b><?php print _('Transport Facility') ?></b><br/>
					<span style="font-size: 90%"><i></i></span>
				</td>
				<td class="right">
