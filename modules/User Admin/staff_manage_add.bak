...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/staff_manage_add.php")==FALSE) {
	...
	?>
	<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/staff_manage_addProcess.php?search=$search" ?>">
		<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
			...
			<tr>
				<td style='width: 275px'> 
					<b><?php print _('UAN no.') ?> *</b><br/>
				</td>
				<td class="right">
					<input name="uan" id="uan" maxlength=12 value="" type="text" style="width: 300px" required>
				<td>
			</tr>
