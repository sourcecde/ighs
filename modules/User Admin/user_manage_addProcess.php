...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/user_manage_add.php")==FALSE) {
	...
	*/
	...
	if(isset($_POST["citizenship1Passport"]))
	{
	 ...
	 $citizenship2='';
	if(isset($_POST["citizenship2"]))
	{
		$citizenship2=$_POST["citizenship2"] ;
	}
	$citizenship2Passport='';
	if(isset($_POST["citizenship2Passport"]))
	{
	...
	$annual_incode=$_POST["annual_incode"];
	...
	if ($surname=="" OR $firstName==""  OR $officialName=="" OR $gender=="" OR $username=="" OR $password=="" OR $passwordConfirm=="" OR $status=="" OR $gibbonRoleIDPrimary=="") {
		//Fail 3
		$URL.="&addReturn=fail3" ;
		header("Location: {$URL}");
	}
