...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/user_manage_delete.php")==FALSE) {
	...
	if ($gibbonPersonID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/user_manage_deleteProcess.php?gibbonPersonID=$gibbonPersonID&search=" . $_GET["search"] ?>">
