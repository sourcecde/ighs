...
if (isActionAccessible($guid, $connection2, "/modules/User Admin/data_medical_delete.php")==FALSE) {
	...
	print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . _("Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . _(getModuleName($_GET["q"])) . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/User Admin/data_medical.php'>" . _('Medical Data Updates') . "</a> > </div><div class='trailEnd'>" . _('Delete Request') . "</div>" ;
	print "</div>" ;
	...
	if ($gibbonPersonMedicalUpdateID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/data_medical_deleteProcess.php?gibbonPersonMedicalUpdateID=$gibbonPersonMedicalUpdateID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					...
					<tr>
						<td> 
							<input name="gibbonPersonMedicalUpdateID" id="gibbonPersonMedicalUpdateID" value="<?php print $gibbonPersonMedicalUpdateID ?>" type="hidden">
