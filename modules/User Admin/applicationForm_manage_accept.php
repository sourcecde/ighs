					...
					<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
						<tr>
							<td> 
								...
								?>
								<input <?php print $checkedStudent ?> type='checkbox' name='informStudent'/> <?php print _('Automatically inform <u>student</u> of their login details by email?') ?><br/>
								<?php
								$checkedParents="" ;
								...
								?>
								<input <?php print $checkedParents ?> type='checkbox' name='informParents'/> <?php print _('Automatically inform <u>parents</u> of their login details by email?') ?><br/>
								
								<br/>
								<i><u><?php print _('The system will perform the following actions:') ?></u></i><br/>
								<ol>
									<li><?php print _('Creates user account for the student.') ?></li>
									<?php
								...
								<ol>
									...
									<li><?php print _('Create a note of the student\'s scholarship information.') ?></li>
				...
				if ($failStudent==TRUE) {
						...
						if ($lock==true) {
							...
							if ($gotAI==true) {
								...
								if ($row["parent1surname"]==$row["parent2surname"] AND $row["parent2preferredName"]!="" AND $row["parent2title"]!="") {
									$nameAddress=$row["parent1title"] . "& " . $row["parent2title"] . $row["parent2surname"] ;
								}
					...
					if ($failStatus==true) {
						...
						print "<ol>" ;
							...
							print "<li>" . _('Create a note of the student\'s scholarship information.') . "</li>" ;
							print "<li>" . _('Create a timetable for the student.') . "</li>" ;
							print "<li>" . _('Inform the student and their parents of their login details (if this was not done automatically).') . "</li>" ;
						print "</ol>" ;
						print "</div>" ;
						print "<div style='text-align:center;'><br/><button><a href='".$_SESSION[$guid]["absoluteURL"]."/index.php?q=/modules/User%20Admin/applicationForm_manage.php'>Back</a></button></div>";
					}
				}
			}
		}
