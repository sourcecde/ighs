...
try {
	...
	$sql="SELECT gibbonperson.gibbonPersonID, status, gibbonStudentEnrolmentID, surname, preferredName,officialName,gibbonstudentenrolment.gibbonYearGroupID, gibbonperson.boarder,`gibbonperson`.`admission_number`,`gibbonperson`.`enrollment_date`, gibbonyeargroup.name AS yearGroup, gibbonrollgroup.nameShort AS rollGroup,`gibbonstudentenrolment`.`gibbonRollGroupID`,account_number,gibbonstudentenrolment.rollOrder FROM gibbonperson, gibbonstudentenrolment, gibbonyeargroup, gibbonrollgroup WHERE (gibbonperson.gibbonPersonID=gibbonstudentenrolment.gibbonPersonID) AND (gibbonstudentenrolment.gibbonYearGroupID=gibbonyeargroup.gibbonYearGroupID) AND (gibbonstudentenrolment.gibbonRollGroupID=gibbonrollgroup.gibbonRollGroupID) AND gibbonstudentenrolment.gibbonSchoolYearID={$filterYear} AND (dateStart IS NULL OR dateStart<='" . date("Y-m-d") . "') AND (dateEnd IS NULL  OR dateEnd>='" . date("Y-m-d") . "') AND gibbonperson.status='Full'";
	$sql.=$sqlFilter;
				...
				print "<tbody>";
					...
					while ($row=$resultPage->fetch()) {
						...
						print "<td id='t_Account_{$row['gibbonStudentEnrolmentID']}'>" ;
							...
							print "</td>" ;
							print "<td id='t_Admission_{$row['gibbonStudentEnrolmentID']}'>" ;
								print "<span id='Admission_{$row['gibbonStudentEnrolmentID']}'>".$row["admission_number"]."</span>" ;
							print "</td>" ;
							print "<td>" ;
