...
if (isActionAccessible($guid, $connection2, "/modules/Timetable Admin/ttDates_edit_delete.php")==FALSE) {
	...
	if ($gibbonSchoolYearID=="" OR $dateStamp=="" OR $gibbonTTDayID=="") {
		...
		if ($result->rowCount()<1) {
			...
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/ttDates_edit_deleteProcess.php?gibbonSchoolYearID=$gibbonSchoolYearID&dateStamp=$dateStamp&gibbonTTDayID=$gibbonTTDayID" ?>">
