...
if (isActionAccessible($guid, $connection2, "/modules/Fee/payment_parent.php")==FALSE) {
	//Acess denied
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td align="center" colspan="3">
		  <input type="hidden" id="student_personID" value="<?php echo $_SESSION[$guid]["gibbonPersonID"]; ?>"> 
		  <select name="fianacialyear" id="fianacialyear" style="float:left;">
  ...
  <tr>
  	...
  	<table width="100%" cellpadding="0" cellspacing="0">
			<tr class="hide_from_parent">
  			...
  			<?php foreach ($all_fee_type as $value) {
				array_push($fee_jsonarr, $value['fee_type_desc']);
  				...
  				?>
  			<tr id="fee_row<?=$value['fee_type_desc']?>" style="display:none;">
		...
		<input type="button" name="pay" id="pay" value="Pay" style="float:right;margin-right:100px">&nbsp;
  	</td>
  	<td valign="top" width="45%" class='hide_from_parent'>
  		<table width="100%" cellpadding="0" cellspacing="0">
  		<tr class="hide_from_parent">
  		...
  		<tr class="hide_from_parent">
  			...
  			<td>
  			<input type="hidden" name="payment_mode" id="payment_mode" value="payment_gateway">
  			</td>
  		</tr>
  		<tr class="hide_from_parent cheque draft">
  			<td width="50%" style="text-align: right;">Receiving Bank</td>
  			<td>
			<input name='bankID' id='bankID' value='4'>
  			</td>
  		</tr>
