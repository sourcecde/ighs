...
$total_fine=0;
$total_amount=0;
$sql="SELECT gibbonstudentenrolment.*,gibbonperson.officialName,gibbonperson.firstName,gibbonperson.surname,gibbonyeargroup.name,gibbonrollgroup.name AS section 
  ...
  <tr>
        <td>
		    <select name="src_student" id="src_student">
		    	...
		    	<option value="<?php echo $value['gibbonStudentEnrolmentID']?>" <?php if($student_id==$value['gibbonStudentEnrolmentID']){?> selected="selected"<?php } ?>><?php echo $value['officialName']?> - <?php echo $value['section']?></option>
		    		<?php } ?>
		    </select>
    </td>
