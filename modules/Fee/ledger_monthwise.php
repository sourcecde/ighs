...
if (isActionAccessible($guid, $connection2, "/modules/Fee/ledger_monthwise.php")==FALSE) {
	//Acess denied
...
$postURL=$_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/ledger_monthwise.php";
 ...
 <div style='border: 1px solid #7030a0; margin:10px; padding:5px;'>
	...
	<table width='100%' cellpadding='0' cellspacing='0'>
		<tr>
			...
			<td>
				<select id='section_name' name='section_name' style='float:left; width:150px' required>
...
include("modules/" . $_SESSION[$guid]["module"] . "/ledger_template.php");
 ...
 <input type='hidden' name='action' id='action' value='getMonthwise'>
...
?>
<form class='form_ledger_print' method='POST' action='<?=$_SESSION[$guid]["absoluteURL"] ."/modules/" . $_SESSION[$guid]["module"] . "/ledger_monthwise_print.php"?>' target='_blank'>
