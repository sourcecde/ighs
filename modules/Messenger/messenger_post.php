						...
						<tr id="smsRow">
							<td colspan=2> 
								<div class='error' style='margin-top: 3px'>
									...
									<?php
									if ($smsURLCredit!="") {
										$query="?user=". $smsUsername .":".$smsPassword."&type=0";   
										/*       */
										$curlSession = curl_init();
										curl_setopt($curlSession, CURLOPT_URL, $smsURLCredit . $query);
										...
										curl_close($curlSession);
											...
											print "<b>" . sprintf(_('Current balance: %1$s credit(s).'), $result[1]) . "</u></b>" ;
